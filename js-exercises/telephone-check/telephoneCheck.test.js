...
describe("telephoneCheck", () => {
  test("should return correct boolean", () => {
    ...
    expect(telephoneCheck("1 1 (555) 555-5555")).toBe(false);
    ...
    expect(telephoneCheck("(757) 622-7382")).toBe(true);
    ...
    expect(telephoneCheck("(555)555-5555 (555)555-5555")).toBe(false);
    expect(telephoneCheck("(555)555-5555(555)555-5555")).toBe(false);
  });
});
